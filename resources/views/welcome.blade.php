...
<header class="relative sm:flex sm:justify-center sm:items-start bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
    <div>
        <a href="/">
...
<body class="antialiased">
    <div>
        <div
            ...
            <div class="container page sm:flex sm:justify-center sm:items-start min-h-screen">
                @yield('content')
            </div>
            @yield('scripts')
        </div>
